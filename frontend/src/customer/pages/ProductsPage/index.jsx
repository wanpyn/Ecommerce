...
import { filters, singleFilters, sortOptions } from "../../../data/filterData";
import {
  FormControl,
  FormControlLabel,
  FormLabel,
...
import lengha_choli from "../../../data/Women/LenghaCholi.json";
...
export default function ProductPage() {
  ...
  switch (lastSegment) {
    case "women_top":
      productList = women_top.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "women_jeans":
      productList = women_jeans.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "women_dress":
      productList = women_dress.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "lengha_choli":
      productList = lengha_choli.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "men_jeans":
      productList = men_jeans.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "shirt":
      productList = men_shirt.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    case "mens_kurta":
      productList = mens_kurta.map((item) => (
        <ProductCard key={item.id} item={item} />
      ));
      break;
    default:
      productList = null; // Handle default case if needed
      break;
  }
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <h2 className="text-lg font-bold tracking-tight text-gray-700 mb-5">
              Filters
            </h2>

            <div className="grid grid-cols-1 gap-y-10 lg:grid-cols-5">
              {/* Filters */}
              <form className="hidden lg:block border p-5">
                {/* <h3 className="sr-only">Categories</h3>
                <ul
                  role="list"
