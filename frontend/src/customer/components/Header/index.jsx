        ...
        <nav aria-label="Top" className="mx-auto">
          <div className="border-b border-gray-200">
            <div className="flex h-20 items-center px-11">
              ...
              {/* Flyout menus */}
              <Popover.Group className="hidden lg:ml-16 lg:block lg:self-stretch z-10">
                <div className="flex h-full space-x-8">
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                ...
                                "relative z-10 -mb-px flex items-center border-b-2 pt-px text-xs font-bold transition-colors duration-200 ease-out"
                              )}
                            >
                              {category.name}
                            </Popover.Button>
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-xs font-bold capitalize text-gray-700 hover:text-gray-800 cursor-pointer"
                    >
                      {page.name}
                    </a>
                  ))}
